$( "body[data-page='QuestionsRechner']" ).ready(function() {
    if (typeof calendarAIRONNE === "undefined") { var calendarAIRONNE = {}; }

    calendarAIRONNE.namespace = function(master_node) {
        let date = new Date();
        ...
        function calendar_switch_month(option, input_date) {
            ...
            calendar_master = document.querySelector(master_node);
